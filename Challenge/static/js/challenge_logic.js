...
// Third tile layer for daytime navigation. 
...
//Fourth tile layer for outdoor topography. 
...
let baseMaps = {
  ...
  "Daytime_Navigation": dayNav, 
  "Outdoors": outdoors
};

// Add a 2nd layer group for the tectonic plate data and earthquakes.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();


// Add a reference to the tectonic plates group and the earthquakes groups to the overlays object.
let overlays = {
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(medata) {
    ...
    function getColor(magnitude) {
      ...
      // return colors greater than mag 4 = less than mag 5 
      return "#ea822c";
    }
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(pdata) {
    ...
    // Creating a GeoJSON layer with the retrieved plate data.
    L.geoJson(pdata, {
      // add styling components for line strings 
      color: "#ff6928",
      weight: 3

      // Close GeoJson and add to the tectonicPlates layergroup 
